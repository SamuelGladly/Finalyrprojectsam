...
if SELECT == "Home":
 ...
 st.subheader('Domain:')
 st.subheader('Data Science And Analytics')
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    multi = ( """Quarterly data for the last year for each region is available for free download on this page. https://insideairbnb.com/get-the-data/ Airbnb has provided many travellers a great, easy and convenient place to stay during their travels." 
...
" However, with so many listings available with varying prices, how can an aspiring host know what type of property to invest in "
...
with col2:
    ...
    col2.subheader("REG NO : 212624405008")
    col2.subheader("SMIT COLLEGE")
